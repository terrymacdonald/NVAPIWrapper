...
namespace NVAPIWrapper
{
    ...
    public sealed class NVAPIDisplayHelper : IDisposable
    {
        ...
        public unsafe NVAPIInfoFrameDataDto? InfoFrameControl(NVAPIInfoFrameDataDto data)
        {
            ...
            if (status == _NvAPI_Status.NVAPI_NOT_SUPPORTED || status == _NvAPI_Status.NVAPI_NVIDIA_DEVICE_NOT_FOUND || status == _NvAPI_Status.NVAPI_INVALID_ARGUMENT)
                return null;
        ...
        /// <summary>
        /// Get scanout composition parameter for this display.
        /// </summary>
        ...
        /// <summary>
        /// Set scanout composition parameter for this display.
        /// </summary>
        /// <param name="parameter">Parameter settings.</param>
        /// <returns>True if applied or unchanged, false if unavailable.</returns>
        public unsafe bool SetScanoutCompositionParameter(NVAPIGpuScanoutCompositionParameterDto parameter)
        {
            ThrowIfDisposed();
            ...
            var current = GetScanoutCompositionParameter(parameter.Parameter);
            if (current == null)
                return false;
        ...
        /// <summary>
        /// Get scanout configuration for this display.
        /// </summary>
        /// <returns>Scanout configuration DTO, or null if unavailable.</returns>
        public unsafe NVAPIGpuScanoutConfigurationDto? GetScanoutConfiguration()
        {
            ThrowIfDisposed();
        ...
        /// <summary>
        /// Get extended scanout configuration for this display.
        /// </summary>
        /// <returns>Scanout configuration DTO, or null if unavailable.</returns>
        public unsafe NVAPIGpuScanoutConfigurationExDto? GetScanoutConfigurationEx()
        {
            ThrowIfDisposed();
        ...
        /// <summary>
        /// Get scanout intensity state for this display.
        /// </summary>
        /// <returns>Scanout intensity state DTO, or null if unavailable.</returns>
        public unsafe NVAPIGpuScanoutIntensityStateDto? GetScanoutIntensityState()
        {
            ThrowIfDisposed();
        ...
        /// <summary>
        /// Set scanout intensity for this display.
        /// </summary>
        /// <param name="data">Scanout intensity data.</param>
        /// <returns>Result DTO, or null if unavailable.</returns>
        public unsafe NVAPIGpuScanoutIntensityResultDto? SetScanoutIntensity(NVAPIGpuScanoutIntensityDataDto data)
        {
            ThrowIfDisposed();
        ...
        /// <summary>
        /// Get scanout warping state for this display.
        /// </summary>
        /// <returns>Scanout warping state DTO, or null if unavailable.</returns>
        public unsafe NVAPIGpuScanoutWarpingStateDto? GetScanoutWarpingState()
        {
            ThrowIfDisposed();
        ...
        /// <summary>
        /// Set scanout warping for this display.
        /// </summary>
        /// <param name="data">Scanout warping data.</param>
        /// <returns>Result DTO, or null if unavailable.</returns>
        public unsafe NVAPIGpuScanoutWarpingResultDto? SetScanoutWarping(NVAPIGpuScanoutWarpingDataDto data)
        {
            ThrowIfDisposed();
