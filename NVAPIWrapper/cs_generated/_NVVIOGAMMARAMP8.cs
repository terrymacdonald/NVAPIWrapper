...
{
    /// <include file='_NVVIOGAMMARAMP8.xml' path='doc/member[@name="_NVVIOGAMMARAMP8"]/*' />
    public partial struct _NVVIOGAMMARAMP8
    {
        /// <include file='_NVVIOGAMMARAMP8.xml' path='doc/member[@name="_NVVIOGAMMARAMP8.uRed"]/*' />
        [NativeTypeName("NvU16[256]")]
        public _uRed_e__FixedBuffer uRed;

        /// <include file='_NVVIOGAMMARAMP8.xml' path='doc/member[@name="_NVVIOGAMMARAMP8.uGreen"]/*' />
        [NativeTypeName("NvU16[256]")]
        public _uGreen_e__FixedBuffer uGreen;

        /// <include file='_NVVIOGAMMARAMP8.xml' path='doc/member[@name="_NVVIOGAMMARAMP8.uBlue"]/*' />
        [NativeTypeName("NvU16[256]")]
