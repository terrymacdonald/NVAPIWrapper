...
{
    /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2"]/*' />
    public partial struct _NV_GPU_PERF_PSTATES20_INFO_V2
    {
        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.version"]/*' />
        [NativeTypeName("NvU32")]
        public uint version;

        public uint _bitfield;

        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.bIsEditable"]/*' />
        ...
        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.reserved"]/*' />
        ...
        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.numPstates"]/*' />
        [NativeTypeName("NvU32")]
        public uint numPstates;

        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.numClocks"]/*' />
        [NativeTypeName("NvU32")]
        public uint numClocks;

        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.numBaseVoltages"]/*' />
        [NativeTypeName("NvU32")]
        public uint numBaseVoltages;

        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.pstates"]/*' />
        [NativeTypeName("struct (anonymous struct at ./../nvapi/nvapi.h:1287:5)[16]")]
        public _pstates_e__FixedBuffer pstates;

        /// <include file='_NV_GPU_PERF_PSTATES20_INFO_V2.xml' path='doc/member[@name="_NV_GPU_PERF_PSTATES20_INFO_V2.ov"]/*' />
        [NativeTypeName("__AnonymousRecord_nvapi_L1308_C5")]
        public _ov_e__Struct ov;
        ...
        /// <include file='_ov_e__Struct.xml' path='doc/member[@name="_ov_e__Struct"]/*' />
        public partial struct _ov_e__Struct
        {
            /// <include file='_ov_e__Struct.xml' path='doc/member[@name="_ov_e__Struct.numVoltages"]/*' />
            [NativeTypeName("NvU32")]
            public uint numVoltages;

            /// <include file='_ov_e__Struct.xml' path='doc/member[@name="_ov_e__Struct.voltages"]/*' />
            [NativeTypeName("NV_GPU_PSTATE20_BASE_VOLTAGE_ENTRY_V1[4]")]
