...
namespace NVAPIWrapper
{
    public static unsafe partial class NVAPI
    {
        ...
        public static delegate* unmanaged[Cdecl]<NvPhysicalGpuHandle__*, _NVLINK_GET_CAPS_EX_V1*, _NvAPI_Status> NvAPI_GPU_NVLINK_GetCapsEx;
        ...
        public static delegate* unmanaged[Cdecl]<NvPhysicalGpuHandle__*, _NVLINK_GET_STATUS_EX_V1*, _NvAPI_Status> NvAPI_GPU_NVLINK_GetStatusEx;
        ...
        public static delegate* unmanaged[Cdecl]<NvPhysicalGpuHandle__*, _NV_GPU_OVERCLOCK_STATUS_V1*, _NvAPI_Status> NvAPI_GPU_GetOverclockStatus;
        ...
        public static delegate* unmanaged[Cdecl]<NvGSyncDeviceHandle__*, uint*, _NV_GSYNC_GPU*, uint*, _NV_GSYNC_DISPLAY_V2*, _NvAPI_Status> NvAPI_GSync_GetTopology;

        /// <include file='NVAPI.xml' path='doc/member[@name="NVAPI.NvAPI_GSync_SetSyncStateSettings"]/*' />
        public static delegate* unmanaged[Cdecl]<uint, _NV_GSYNC_DISPLAY_V2*, uint, _NvAPI_Status> NvAPI_GSync_SetSyncStateSettings;
        ...
        public static delegate* unmanaged[Cdecl]<_NV_NGX_DLSS_OVERRIDE_GET_STATE_PARAMS_V2*, _NvAPI_Status> NvAPI_NGX_GetNGXOverrideState;
        ...
        public static delegate* unmanaged[Cdecl]<_NV_NGX_SESSION_PARAMS_V1*, _NvAPI_Status> NvAPI_NGX_OpenSession;

        /// <include file='NVAPI.xml' path='doc/member[@name="NVAPI.NvAPI_NGX_CloseSession"]/*' />
        public static delegate* unmanaged[Cdecl]<_NV_NGX_SESSION_PARAMS_V1*, _NvAPI_Status> NvAPI_NGX_CloseSession;

        /// <include file='NVAPI.xml' path='doc/member[@name="NVAPI.NvAPI_NGX_SetRuntimeParams"]/*' />
        public static delegate* unmanaged[Cdecl]<_NV_NGX_SET_RUNTIME_PARAMS_V1*, _NvAPI_Status> NvAPI_NGX_SetRuntimeParams;

        /// <include file='NVAPI.xml' path='doc/member[@name="NVAPI.NvAPI_NGX_GetRuntimeParams"]/*' />
        public static delegate* unmanaged[Cdecl]<_NV_NGX_GET_RUNTIME_PARAMS_V1*, _NvAPI_Status> NvAPI_NGX_GetRuntimeParams;
